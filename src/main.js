...
const DEFAULTS = {
  couchUrl: 'https://obsidian.enfycius.com',      // CouchDB (파일 동기화)
  wsUrl: 'wss://study-collab.smallws.com',        // AI 스터디 전용 relay (실시간 협업)
  dbName: 'ai-study-db',
  docPrefix: 'cvs:',
  username: '',
  password: '',
...
const UPDATE_REPO = 'rablove/ai-study-sync';   // 버전 확인 대상(공개 repo)
...
export default class VaultSyncCollab extends Plugin {
  ...
  async gatedSync() {
    ...
    try { await this.pullAllFromServer(onProg); } catch (e) {}   // 전체 문서 catch-up (실시간 가능 지점까지)
